...
class Pasillo extends Escenario
{
    ...
    private final ubicationY;                    //ubicacion y esta es constante
    /**
    ...
    public pasillo(String nombreFondo, int tpPas, Jugador jug)
    {
       ...
       //metodo segun tipo de pasillo  haga el arreglo de puertas
       //hacer unn switch para los seis pasillos
       //cada pasillo tiene su arreglo de puertas 
